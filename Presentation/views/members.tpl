...
% end
</select><button class="button secondary" onclick="location.href='/vloge'" data-permission="admin">Uredi vloge</button><button class="button primary" data-member-dialog data-permission="admin">＋ Dodaj člana</button></div>
