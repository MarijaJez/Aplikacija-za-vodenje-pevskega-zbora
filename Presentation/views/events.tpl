<div class="page-tools"><span class="spacer"></span><a class="button secondary" href="/dogodki/koledar.ics">Izvozi v Google Koledar</a><button class="button primary" data-event-dialog data-permission="admin">＋ Dodaj dogodek</button></div><div class="event-page">
% for event in events:
